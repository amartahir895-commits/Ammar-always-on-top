...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY Λ௱௱Λ尺 н4ㄈҚ3尺 
"""
            else:
        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] FLASH_FF",  # Nickname
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]Λ௱௱Λ尺 н4ㄈҚ3尺 [00FF00]!!
"""
...
[FFFFFF]          ⚡ Λ௱௱Λ尺 н4ㄈҚ3尺 ❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]Λ௱௱Λ尺 н4ㄈҚ3尺    
[FFD700]✨ কেউ GUILD BOT কিনতে চাইলে telegram এ message করবেন, telegram username @AmmarDevx ❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> Λ௱௱Λ尺 н4ㄈҚ3尺 ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "Λ௱௱Λ尺 н4ㄈҚ3尺", key, iv)
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]Λ௱௱Λ尺 н4ㄈҚ3尺
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]ENHANCED V1
[00FFFA]╚═•══•════════════════•══•═╝"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To Λ௱௱Λ尺 н4ㄈҚ3尺's BOT"
...
│  └─ [FF0000]/ai [question]
├─ [00AAFF]Admin Information
│  └─ [FF0000]/admin
└─ [00AAFF]Bot Status Check
   └─ [FF0000]/status
[00AAFF]━━━━━━━━━━━━[FF0000]"""
...
async def MaiiiinE():
    Uid , Pw = '4476157904','AMMAROP_4NOTD_BY_MG24_GAMER_OM3W9'
    ...
    os.system('clear')
    print("Initializing Λ௱௱Λ尺 н4ㄈҚ3尺 Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('Λ௱௱Λ尺 н4ㄈҚ3尺s', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 Λ௱௱Λ尺 н4ㄈҚ3尺 BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
    print(f"🔹 Status: 🟢 READY")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using Λ௱௱Λ尺 н4ㄈҚ3尺")
    sys.exit(0)
